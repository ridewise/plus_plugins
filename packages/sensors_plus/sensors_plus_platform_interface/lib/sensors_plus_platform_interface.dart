...
import 'src/attitude_rotation_matrix_event.dart';
...
export 'src/attitude_rotation_matrix_event.dart';
...
abstract class SensorsPlatform extends PlatformInterface {
  ...
  Stream<AttitudeRotationMatrixEvent> get attitudeRotationMatrixEvents {
    throw UnimplementedError('attitudeRotationMatrixEvents has not been implemented.');
  }
}
